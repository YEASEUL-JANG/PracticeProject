...
class BookService (
        ...
        private val userLoanHistoryQureydslRepository: UserLoanHistoryQuerydslRepository
){
    ...
    fun loanBook(request:BookLoanRequest){
        ...
        if(userLoanHistoryQureydslRepository.find(request.bookName,UserLoanStatus.LOANED) != null){
...
//        return userLoanHistoryRepository.findAllByStatus(UserLoanStatus.LOANED).size;
        return userLoanHistoryQureydslRepository.count(UserLoanStatus.LOANED).toInt();
    }
    //분야별 등록되어 있는 책의 권 수
    @Transactional(readOnly = true)
